...
(* OASIS_START *)
(* DO NOT EDIT (digest: cde475aeec20a6e33e75f71118dd94f7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["sachour@mit.edu"];
          homepage = None;
          synopsis = "ocaml bindings for sympy";
          description = None;
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("pycaml", None)];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "¬\155qÅAz)\137\151\128Ô_ü\149\019.";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
